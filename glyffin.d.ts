...
import {Void, Inset1, Inset2, TexelRect, Spot, Presentation, Patch, Removable} from "./glyffin-type";
...
declare class Perimeter {
    ...
    constructor(left : number, top : number, right : number, bottom : number, age : number,
                level : number, tapHeight : number, readHeight : number, palette : Palette);
...
export declare var EMPTY_REMOVABLE : Removable;
...
export declare class PagenGesturing implements Gesturing {
    constructor(downSpot : Spot, minCharging : number, onStarted : (pixelsMoved : number) => void,
                onCanceled : () => void, onFinished : (velocity : number) => void);
...
export declare class HorizontalGesturing implements Gesturing {
    constructor(downSpot : Spot, chargingSize : number, chargingDirection : number,
                onStarted : (pixelsMoved : number) => void, onCanceled : () => void,
                onFinished : () => void);
...
export declare class VerticalGesturing implements Gesturing {
    constructor(downSpot : Spot, minMove : number, onStarted : (down : number) => void,
                onCanceled : () => void, onFinished : () => void);
...
export declare class Glyff<T> {
    ...
    revealDown<U>(inset : Inset1, revelation : Glyff<U>,
                  startDown? : boolean) : Glyff<T | U | string>;
...
export declare function colorPath(colorPath : number[], mix? : number,
